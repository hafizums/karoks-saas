<div
    class="karaoke-stage {{ ($compact ?? true) ? 'is-compact' : '' }}"
...
>
    <header class="stage-header">
        <div class="stage-header-row">
            ...
            @if ($showMockBadge ?? false)
                <span class="inline-flex items-center rounded-full bg-amber-100 px-2 py-0.5 text-[11px] font-medium text-amber-900 dark:bg-amber-950/60 dark:text-amber-100">
                    Simulated result
                </span>
            @endif
        </div>
    ...
    <div class="karaoke-controls">
        <p
            ...
            role="alert"
        >
            Audio is unavailable. The instrumental file may be missing or unsupported in your browser.
        </p>
